...
合计: **293,021** 行代码（覆盖前 5 种语言、共 **1513** 个文件）。
...
- **Star**: 886 · **Fork**: 34 · **开放 issue**: 122 · **贡献者**: 17

## 累计统计

- **发布数**: 170 · **已合并 PR**: 607 · **开放 PR**: 2 · **已关闭 issue**: 117 · **开放 issue**: 5 · **提交数**: 1120
...
在 [repology.org](https://repology.org/project/lfk) 上共有 **6** 个发行版报告此项目。**2** 个 ✅ 已是最新上游版本，**4** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T20:50:18Z._
