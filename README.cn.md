...
合计: **286,060** 行代码（覆盖前 5 种语言、共 **1521** 个文件）。
...
- **发布数**: 171 · **已合并 PR**: 621 · **开放 PR**: 9 · **已关闭 issue**: 118 · **开放 issue**: 4 · **提交数**: 1134
...
在 [repology.org](https://repology.org/project/lfk) 上共有 **6** 个发行版报告此项目。**3** 个 ✅ 已是最新上游版本，**3** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260913.yml` · 2026-09-13T05:33:07Z._
